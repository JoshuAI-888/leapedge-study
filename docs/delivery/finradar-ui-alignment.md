...
- Desktop: table/card switching, save in table, saved state retained in cards and across navigation, unsave in cards, Settings appearance save, trust heading sorting; Show more expands from 5 to 15 calls and then removes the button after displaying all matching calls. Inspected 1440 × 1100 screenshot.

...
const prompts = process.argv.includes("--baseline")
  ? shadowPrompts(true)
  : fidelityPrompts();
...
const promptHash = createHash("sha256")
  ...
  .digest("hex");
const resultPath = `${directory}/${caseName}-${process.argv.includes("--baseline") ? "single-segment-baseline" : "v7-fidelity"}-shadow.json`;
